        ...
        <div class="row">
            <div class="col-lg-3 p-0" style="background-color: #ffffff">
                ...
                <div class="list-group">
                    <a href="candidate-list" class="list-group-item list-group-item-action border-0 active"><span class="text-success"><i class="fa fa-caret-square-o-down"></i> Manage Candidate</span></a>       
            ...
            <div class="col-lg-9">
                ...
                <div class="shadow-sm p-4 mb-4 bg-white">
                    <h2 class="text-danger text-center"><b>MANAGE CANDIDATE</b></h2>
                </div>

                <div class="float-left">
                    <a class="btn btn-success" href="add-candidate">Add Candidate</a>
                </div>
                            ...
                            <tbody id="myTable">
                                <c:forEach var="a" items="${listCandidate}">
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" data-toggle="modal" data-toggle="tooltip" title="Contact" data-target="#contact${a.candidateID}">
                                ...
                                <!-- The Modal: Contact -->
                                <div class="modal" id="contact${a.candidateID}">
